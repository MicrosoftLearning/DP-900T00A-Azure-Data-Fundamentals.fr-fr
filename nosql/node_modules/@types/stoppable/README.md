...
ms.locfileid: "138051050"
---
# <a name="installation"></a>Installation
> `npm install --save @types/stoppable`

# <a name="summary"></a>Résumé
Ce package contient des définitions de type pour les éléments stoppables (https://github.com/hunterloftis/stoppable).

# <a name="details"></a>Détails
Les fichiers ont été exportés à partir de https://github.com/DefinitelyTyped/DefinitelyTyped/tree/master/types/stoppable.
 ...
 * Dernière mise à jour : Lundi 31 mai 2021 17:01:23 GMT
 * Dépendances : [@types/node](https://npmjs.com/package/@types/node)
 * Valeurs globales : aucune

# <a name="credits"></a>Crédits
Ces définitions ont été écrites par [Eric Byers](https://github.com/EricByers), [John Plusjé](https://github.com/jplusje) et [BendingBender](https://github.com/BendingBender).
