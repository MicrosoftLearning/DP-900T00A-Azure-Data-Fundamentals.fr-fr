...
ms.locfileid: "138051462"
---
# <a name="nodejs-abi"></a>ABI Node.js

[![État de la build](https://travis-ci.org/lgeiger/node-abi.svg?branch=v1.0.0)](https://travis-ci.org/lgeiger/node-abi) [![Badge Greenkeeper](https://badges.greenkeeper.io/lgeiger/node-abi.svg)](https://greenkeeper.io/)


Obtenez l’ABI Node pour une cible et un runtime donnés, et vice versa.
